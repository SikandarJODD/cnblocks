...
const corePreviewConfig = [
  ...
  { category: "feature", modulePath: "$lib/all_blocks/features", exportName: "feature", count: 14 },
  { category: "content", modulePath: "$lib/all_blocks/content", exportName: "content", count: 7 },
  { category: "integration", modulePath: "$lib/all_blocks/integration", exportName: "integration", count: 8 },
  ...
  { category: "comparator", modulePath: "$lib/all_blocks/comparator", exportName: "comparator", count: 1 },
  { category: "logocloud", modulePath: "$lib/all_blocks/logo-cloud", exportName: "logocloud", count: 3 },
