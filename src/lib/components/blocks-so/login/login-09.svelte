...
<div class="flex min-h-screen items-center justify-center">
  <div class="w-full max-w-md">
    <Card class="border-none shadow-lg pb-0">
      <CardHeader class="flex flex-col items-center space-y-1.5 pb-4 pt-6">
      ...
      <CardContent class="space-y-6 px-8">
        <div class="space-y-2">
          ...
          <Select value="designer" type="single">
            <SelectTrigger
              id="role"
            ...
            >
              ...
              <SelectItem value="manager">
                ...
                <span class="truncate">Product Manager</span>
              </SelectItem>
            </SelectContent>
          </Select>
        </div>
        ...
        <div class="space-y-2">
          ...
          <div class="relative">
            ...
            <Button
              ...
              variant="ghost"
              size="icon"
              class="absolute right-0 top-0 h-full px-3 text-muted-foreground hover:bg-transparent"
