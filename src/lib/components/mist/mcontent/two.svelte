	...
	<div class="bg-muted/50 py-24">
		<div class="mx-auto w-full max-w-5xl px-6">
			<div>
				...
				<h2 class="mt-4 text-4xl font-semibold text-foreground">Ask Tailark to Edit anything</h2>
				<p class="mt-4 mb-12 text-lg text-muted-foreground">
					Efficient content creation is our mission. With Tailark, you can effortlessly edit text,
					generate code snippets, format documents, create visualizations from data, and seamlessly
			...
			>
				...
				<div class="grid sm:grid-cols-5">
					...
					<div class="mt-6 sm:col-span-3 sm:mt-0 sm:border-l sm:pt-12 sm:pl-12">
