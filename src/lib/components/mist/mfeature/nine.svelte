...
>
	<div class="py-24">
		<div class="mx-auto w-full max-w-2xl px-6 lg:px-0">
			<div>
				<h2 class="text-center text-4xl font-semibold text-balance text-foreground">
					Empowering developers with AI-driven solutions
				</h2>
			</div>
			<div class="mt-16 space-y-12">
				<div class="grid items-center gap-6 sm:grid-cols-5">
					<Card variant="soft" class="p-6 sm:col-span-2">
				...
				<div class="grid items-center gap-6 sm:grid-cols-5">
					<Card variant="soft" class="overflow-hidden p-6 sm:col-span-2 sm:overflow-clip">
				...
				<div class="grid items-center gap-6 sm:grid-cols-5">
					<Card variant="soft" class="overflow-hidden px-6 sm:col-span-2">
						<div class="-mx-2 -mt-2 mask-b-from-85% px-2 pt-6">
