...
>
  <div class="py-24">
    <div class="mx-auto w-full max-w-3xl px-6">
      <h2
        class="text-foreground text-balance text-3xl font-semibold md:text-4xl"
      >
        <span class="text-muted-foreground"
          >Empowering Marketing teams with</span
        > AI-driven solutions
      </h2>
      <div class="mt-12 grid gap-12 sm:grid-cols-2">
        <div class="col-span-full space-y-4">
          <Card variant="soft" class="overflow-hidden px-6 sm:col-span-2">
            <div class="mask-b-from-75% mx-auto -mt-2 max-w-sm px-2 pt-8">
