...
<footer class="border-b bg-white pt-20 dark:bg-transparent">
  <div class="mb-8 border-b md:mb-12">
    <div
      class="mx-auto flex max-w-5xl flex-wrap items-end justify-between gap-6 px-6 pb-6"
    >
      ...
      >
        <div class="space-y-4">
          ...
          <span class="text-muted-foreground block text-sm"
            >Don't miss any update!</span
          >
        </div>
      </form>
    </div>
    <div
      class="mt-12 flex flex-wrap items-end justify-between gap-6 border-t py-6"
    >
      <small
        class="text-muted-foreground order-last block text-center text-sm md:order-first"
