...
<div class="mx-auto px-4 py-20">
  <h2
    id="benefits-title"
    class="inline-block bg-gradient-to-t from-gray-900 to-gray-800 bg-clip-text py-2 text-3xl font-bold tracking-tighter text-transparent dark:from-gray-50 dark:to-gray-300 md:text-5xl"
  >
    ...
    {#each benefits as benefit,index}
      <div class="col-span-4 sm:col-span-2 lg:col-span-1">
        <dt class="relative font-semibold text-gray-900 dark:text-gray-50">
          {benefit.title}
          <div class="absolute -left-2 top-1 h-4 w-0.5 rounded-full bg-blue-500" ></div>
        </dt>
