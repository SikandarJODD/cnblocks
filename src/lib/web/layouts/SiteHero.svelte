	...
	<main class="relative overflow-hidden">
			...
			<div class="relative pt-6 md:pt-10">
				<div class="mx-auto max-w-7xl px-2 md:px-6">
					<div class="text-center sm:mx-auto lg:mt-0 lg:mr-auto">
						...
						<h1
							class="relative mx-auto mt-6 max-w-3xl bg-gradient-to-br from-neutral-900 via-neutral-700 to-neutral-600 bg-clip-text pb-2 font-display text-3xl font-medium text-balance text-transparent md:text-4xl lg:mt-16 xl:text-6xl/tight dark:from-neutral-100 dark:via-neutral-300 dark:to-neutral-400"
						>
							<div
							...
							<div
								class="absolute top-14 -left-24 hidden w-fit -rotate-12 gap-1 rounded-t-sm border-b border-dashed border-yellow-500 bg-yellow-100/80 pt-0.5 pr-1.5 pl-1 text-sm font-normal text-yellow-500 underline-offset-3 lg:flex dark:bg-yellow-900/30 dark:text-yellow-400"
							>
								<svg
									xmlns="http://www.w3.org/2000/svg"
									width="24"
              ...
              > -->
							...
							<Button
								...
								variant="outline"
								size="lg"
								class="border-dashed border-primary bg-muted px-5 shadow-md dark:border-primary/40"
							>
		...
		<section class="bg-background pt-0 pb-0 md:pb-10">
			<div class="relative m-auto max-w-5xl px-6">
				<div class="mx-auto mt-4 mt-10 flex max-w-2xl justify-center gap-4">
					<div
